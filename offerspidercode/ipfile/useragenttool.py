...
user_agenst = [{"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36"},
...
def get_headers():
    index = int(random.random()*(len(user_agenst))-1)
    return user_agenst[index]


if __name__ == '__main__':
    headers = get_headers()
    print("动态获取UA值",headers)